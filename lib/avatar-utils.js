...
export const BRAND_ICONS = {
  ...
  'gmail.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M4.5 4h15c1.38 0 2.5 1.12 2.5 2.5v.3L12 14.2 2 6.8V6.5C2 5.12 3.12 4 4.5 4z" fill="#EA4335"/><path d="M2 6.8v10.7C2 18.88 3.12 20 4.5 20H6V9.8L2 6.8z" fill="#4285F4"/><path d="M22 6.8v10.7c0 1.38-1.12 2.5-2.5 2.5H18V9.8l4-3z" fill="#34A853"/><path d="M6 9.8V20h12V9.8l-6 4.4-6-4.4z" fill="#FBBC05"/><path d="M6 9.8l6 4.4 6-4.4v-.8L12 13.4 6 9z" fill="#C5221F" opacity="0.25"/></svg>'),
  'outlook.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect x="7" y="3.5" width="14" height="17" rx="2.5" fill="#0078D4"/><path d="M7 5.5l7 5.2 7-5.2" stroke="#50E6FF" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M7 18.5l5.5-4.2M21 18.5l-5.5-4.2" stroke="#004E8C" stroke-width="1.2"/><rect x="2.5" y="6" width="11" height="12" rx="2" fill="#005A9E"/><rect x="3" y="6.5" width="10" height="11" rx="1.6" fill="#106EBE"/><ellipse cx="8" cy="12" rx="2.8" ry="3.5" fill="none" stroke="#FFFFFF" stroke-width="1.7"/></svg>'),
  'hotmail.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect x="7" y="3.5" width="14" height="17" rx="2.5" fill="#0078D4"/><path d="M7 5.5l7 5.2 7-5.2" stroke="#50E6FF" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M7 18.5l5.5-4.2M21 18.5l-5.5-4.2" stroke="#004E8C" stroke-width="1.2"/><rect x="2.5" y="6" width="11" height="12" rx="2" fill="#005A9E"/><rect x="3" y="6.5" width="10" height="11" rx="1.6" fill="#106EBE"/><ellipse cx="8" cy="12" rx="2.8" ry="3.5" fill="none" stroke="#FFFFFF" stroke-width="1.7"/></svg>'),
  'live.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect x="7" y="3.5" width="14" height="17" rx="2.5" fill="#0078D4"/><path d="M7 5.5l7 5.2 7-5.2" stroke="#50E6FF" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M7 18.5l5.5-4.2M21 18.5l-5.5-4.2" stroke="#004E8C" stroke-width="1.2"/><rect x="2.5" y="6" width="11" height="12" rx="2" fill="#005A9E"/><rect x="3" y="6.5" width="10" height="11" rx="1.6" fill="#106EBE"/><ellipse cx="8" cy="12" rx="2.8" ry="3.5" fill="none" stroke="#FFFFFF" stroke-width="1.7"/></svg>'),
  'yahoo.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="5" fill="#6001D2"/><path d="M5.2 6.5l3.3 5.5v5.5h2.4v-5.5l3.3-5.5h-2.5l-2 3.6-2-3.6H5.2z" fill="#FFFFFF"/><path d="M16 7.2a1.2 1.2 0 0 1 1.2-1.2c.7 0 1.2.5 1.2 1.2v5.4a1.2 1.2 0 0 1-1.2 1.2 1.2 1.2 0 0 1-1.2-1.2V7.2z" fill="#FFFFFF"/><circle cx="17.2" cy="16.5" r="1.2" fill="#FFFFFF"/></svg>'),
  'ymail.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="5" fill="#6001D2"/><path d="M5.2 6.5l3.3 5.5v5.5h2.4v-5.5l3.3-5.5h-2.5l-2 3.6-2-3.6H5.2z" fill="#FFFFFF"/><path d="M16 7.2a1.2 1.2 0 0 1 1.2-1.2c.7 0 1.2.5 1.2 1.2v5.4a1.2 1.2 0 0 1-1.2 1.2 1.2 1.2 0 0 1-1.2-1.2V7.2z" fill="#FFFFFF"/><circle cx="17.2" cy="16.5" r="1.2" fill="#FFFFFF"/></svg>'),
  'icloud.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="iclg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#38BDF8"/><stop offset="100%" stop-color="#0284C7"/></linearGradient></defs><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" fill="url(#iclg)"/></svg>'),
  'me.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="iclg2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#38BDF8"/><stop offset="100%" stop-color="#0284C7"/></linearGradient></defs><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" fill="url(#iclg2)"/></svg>'),
  'mac.com': svgDataUrl('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="iclg3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#38BDF8"/><stop offset="100%" stop-color="#0284C7"/></linearGradient></defs><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" fill="url(#iclg3)"/></svg>'),
...
export const GMAIL_AVATAR_PALETTE = [
  { hex: '#d93025', bgClass: 'bg-[#d93025]', name: 'Google Red', gradient: 'linear-gradient(135deg, #d93025, #ea4335)' },
  { hex: '#1a73e8', bgClass: 'bg-[#1a73e8]', name: 'Google Blue', gradient: 'linear-gradient(135deg, #1a73e8, #4285f4)' },
  { hex: '#188038', bgClass: 'bg-[#188038]', name: 'Google Green', gradient: 'linear-gradient(135deg, #188038, #34a853)' },
  { hex: '#ea8600', bgClass: 'bg-[#ea8600]', name: 'Google Amber', gradient: 'linear-gradient(135deg, #ea8600, #fbbc04)' },
  { hex: '#9334e6', bgClass: 'bg-[#9334e6]', name: 'Google Purple', gradient: 'linear-gradient(135deg, #9334e6, #a855f7)' },
  { hex: '#e52592', bgClass: 'bg-[#e52592]', name: 'Google Pink', gradient: 'linear-gradient(135deg, #e52592, #ec4899)' },
  { hex: '#0097a7', bgClass: 'bg-[#0097a7]', name: 'Google Cyan', gradient: 'linear-gradient(135deg, #0097a7, #06b6d4)' },
  { hex: '#00897b', bgClass: 'bg-[#00897b]', name: 'Google Teal', gradient: 'linear-gradient(135deg, #00897b, #14b8a6)' },
  { hex: '#3949ab', bgClass: 'bg-[#3949ab]', name: 'Google Indigo', gradient: 'linear-gradient(135deg, #3949ab, #6366f1)' },
  { hex: '#e64a19', bgClass: 'bg-[#e64a19]', name: 'Google Orange', gradient: 'linear-gradient(135deg, #e64a19, #f97316)' },
  { hex: '#5f6368', bgClass: 'bg-[#5f6368]', name: 'Google Slate', gradient: 'linear-gradient(135deg, #5f6368, #80868b)' },
  { hex: '#7c3aed', bgClass: 'bg-[#7c3aed]', name: 'Google Violet', gradient: 'linear-gradient(135deg, #7c3aed, #8b5cf6)' },
  { hex: '#059669', bgClass: 'bg-[#059669]', name: 'Google Emerald', gradient: 'linear-gradient(135deg, #059669, #10b981)' },
  { hex: '#e11d48', bgClass: 'bg-[#e11d48]', name: 'Google Rose', gradient: 'linear-gradient(135deg, #e11d48, #f43f5e)' },
  { hex: '#0284c7', bgClass: 'bg-[#0284c7]', name: 'Google Sky', gradient: 'linear-gradient(135deg, #0284c7, #38bdf8)' },
  { hex: '#6d4c41', bgClass: 'bg-[#6d4c41]', name: 'Google Brown', gradient: 'linear-gradient(135deg, #6d4c41, #8d6e63)' },
];

/**
 * Validates if an email address string is a valid email format.
 */
 ...
 * Supports optional preferredColor override.
 */
export function getSenderColor(emailOrName, preferredColor = null) {
  if (preferredColor) {
    if (typeof preferredColor === 'string') {
      const match = GMAIL_AVATAR_PALETTE.find(
        p => p.hex.toLowerCase() === preferredColor.toLowerCase() || p.name.toLowerCase() === preferredColor.toLowerCase()
      );
      if (match) return match;
      return { hex: preferredColor, bgClass: '', name: 'Custom', gradient: `linear-gradient(135deg, ${preferredColor}, ${preferredColor})` };
    } else if (preferredColor && preferredColor.hex) {
 ...
 * Prioritizes:
 * 1. For user/personal accounts: Google Profile Photo, Gravatar Direct, Unavatar
 * 2. For verified organizations: Direct Vector Brand SVG, Google S2 Favicon CDN
 * 3. Gravatar / Clearbit / DuckDuckGo for custom domains
 */
export function getAvatarSources(email, size = 160, allowClearbit = true, isUser = false) {
  const clean = extractCleanEmail(email);
  if (!clean) return [];
  ...
  // If this is a personal user account or Gmail address, prioritize personal profile photos
  if (isUser || isFree || domain === 'gmail.com' || domain === 'googlemail.com') {
    // 1. Google Profile Photo via Unavatar Google Provider
    sources.push({
      type: 'google_profile',
    ...
    if (gravatar) {
      sources.push({ type: 'gravatar', url: gravatar, isBrand: false });
    }

    // 3. Universal Unavatar
    sources.push({
      type: 'unavatar',
  ...
  if (domain && (!isFree || domain === 'google.com' || domain === 'youtube.com')) {
    sources.push({
      type: 'google_fav',
  ...
  // 4. If company / custom domain, additional logo sources (Clearbit / DuckDuckGo / Unavatar)
  if (domain && !isFree) {
    if (allowClearbit) {
      sources.push({
        type: 'clearbit',

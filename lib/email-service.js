...
/**
 * Preserve the exact password of the email account without altering characters or spaces
 */
...
async function testConnection(credentials) {
  ...
  try {
    ...
    if (lower.includes('invalid credentials') || lower.includes('authenticationfailed') || lower.includes('username and password not accepted') || lower.includes('auth error') || lower.includes('login failed') || lower.includes('failure')) {
      userFriendlyError = 'Authentication failed: The email address or password entered is incorrect. Please verify your email address and enter your exact email password.';

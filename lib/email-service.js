...
function getProviderAppPasswordGuide(providerOrEmail) {
  ...
  if (val.includes('outlook') || val.includes('microsoft')) return PROVIDER_GUIDES.microsoft;
  if (val.includes('yahoo')) return PROVIDER_GUIDES.yahoo;
  if (val.includes('icloud') || val.includes('apple')) return PROVIDER_GUIDES.icloud;

...
/**
 * Clean password - trim whitespace for standard passwords; strip intra-word spaces for 4x4 app passwords
 */
function sanitizePassword(password, email, provider) {
  ...
  // Strip spaces only if formatted as a 16-character space-separated code (e.g., 'xxxx xxxx xxxx xxxx')

...
/**
 * Convenience generator for standard 16-character Google App Password (4x4 spaced: "xxxx xxxx xxxx xxxx")
 * Compatible with ANY email address (Gmail, Google Workspace, custom domains, or third-party providers).
 */
export function generateGoogleAppPassword() {
